...
public class RegistrationDefinitions {
	...
	public void verify_that_all_alert_fields_show_for_empty_form() {
		...
		assertThat(driver.findElement(By.id("location.errors")).getText(),
				containsString("Location must be between 5 and 50 characters long."));
		assertThat(driver.findElement(By.id("phoneNumber.errors")).getText(),
				containsString("Phone Number must be between 10 and 12 characters long."));
	}

	@Then("^Verify that all alert fields show$")
	public void verify_that_all_alert_fields_show() {
		assertThat(driver.findElement(By.id("firstName.errors")).getText(),
				containsString("First Name must be between 2 and 25 characters long."));
		assertThat(driver.findElement(By.id("lastName.errors")).getText(),
				containsString("Last Name must be between 2 and 25 characters long."));
		assertThat(driver.findElement(By.id("username.errors")).getText(),
				containsString("Username must be between 5 and 25 characters long."));
		assertThat(driver.findElement(By.id("password.errors")).getText(),
				containsString("Password must be between 5 and 50 characters long."));
		assertThat(driver.findElement(By.id("location.errors")).getText(),
				containsString("Location must be between 5 and 50 characters long."));
		assertThat(driver.findElement(By.id("phoneNumber.errors")).getText(),
				containsString("Phone Number must be between 10 and 12 characters long."));
	...
	public void verify_the_first_and_last_name_error() {
		assertThat(driver.findElement(By.id("firstName.errors")).getText(),
				containsString("First name cannot contain numbers."));
		assertThat(driver.findElement(By.id("lastName.errors")).getText(),
				containsString("Last name cannot contain numbers."));
	}

	@Then("^Verify the phone number error$")
	public void verify_the_phone_number_error() {
		assertThat(driver.findElement(By.id("phoneNumber.errors")).getText(),
				containsString("Phonenumber cannot contain letters."));
	}

	@Then("^Verify the password error$")
	public void verify_the_password_error() {
		assertThat(driver.findElement(By.id("confirmPasswordErrorMessage")).getText(),
				containsString("Passwords do not match."));
	}

	@Then("^Verify the username error$")
	public void verify_the_username_error() {
		assertThat(driver.findElement(By.id("usernameTakenError")).getText(),
				containsString("That username is taken, try another"));
	}
