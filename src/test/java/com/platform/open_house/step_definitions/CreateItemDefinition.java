...
public class CreateItemDefinition {
	...
	public void verify_that_all_item_errors_appear() {
	    ...
	    assertThat(driver.findElement(By.id("description.errors")).getText(), containsString("Item must have a description."));
	    assertThat(driver.findElement(By.id("price.errors")).getText(), containsString("Item must have a price or be 0.00"));
	    assertThat(driver.findElement(By.id("expiration.errors")).getText(), containsString("Item must have an expiration."));
	}
	...
	public void verify_that_item_size_errors_appear() {
	    assertThat(driver.findElement(By.id("name.errors")).getText(), containsString("Item name must be betwen 3 and 25 characters"));
	    assertThat(driver.findElement(By.id("description.errors")).getText(), containsString("Item description must be between 10 and 50 characters"));
	}
